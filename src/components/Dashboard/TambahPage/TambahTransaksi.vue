    ...
    methods: {
        async submitTambahTransaksi(e) {
            ...
            const response = await fetch(
                "https://rentalmobilbengkalis.000webhostapp.com/rentalmobil/transaksi.php",
                {
                    method: "post",
                    body: formData,
                }
        ...
        async fecthDataPelanggan() {
            ...
            const response = await fetch(
                `https://rentalmobilbengkalis.000webhostapp.com/rentalmobil/viewpelanggannik.php?nik=${nik}`
            );
